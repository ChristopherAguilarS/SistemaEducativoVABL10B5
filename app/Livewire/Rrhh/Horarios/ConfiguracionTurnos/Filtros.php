...
{
    use LivewireAlert;
    public $selectEstado = 2, $selectCategoria, $selectLugar, $locales, $categorias;

    public function buscar()
    {
        $this->emit('rtabla', $this->selectLugar, $this->selectCategoria, $this->selectEstado);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.rrhh.horarios.configuracion-turnos.filtros');
    }
}
