...
namespace App\Http\Livewire\Rrhh\Configuracion\RegimenPensionario\Components;
...
class Exportar extends Component
{
    ...
    public function render() {
        return view('livewire.rrhh.configuracion.regimen-pensionario.components.exportar');
    }
}
