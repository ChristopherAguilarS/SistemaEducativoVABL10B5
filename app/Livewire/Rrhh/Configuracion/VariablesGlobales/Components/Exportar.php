...
namespace App\Http\Livewire\Rrhh\Configuracion\VariablesGlobales\Components;
...
class Exportar extends Component
{
    ...
    public function render() {
        return view('livewire.rrhh.configuracion.variables-globales.components.exportar');
    }
}
