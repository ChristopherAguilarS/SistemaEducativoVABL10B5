...
namespace App\Livewire\FinancieroContable\Pedidos\CrearPedidos;
...
class Cards extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.financiero-contable.contabilidad.caja-bancos.cards',['deudor'=>$deudor,'acreedor'=>$acreedor,'saldo'=>$saldo]);
    }
}
