...
namespace App\Livewire\FinancieroContable\Pedidos\OrdenServicio;
...
class Cards extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.financiero-contable.contabilidad.orden-servicio.cards',['deudor'=>$deudor,'acreedor'=>$acreedor,'saldo'=>$saldo]);
    }
}
