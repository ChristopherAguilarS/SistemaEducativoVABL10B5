<?php
namespace App\Livewire\Biblioteca\Configuracion\CatalogoEditoriales\Components;
...
class VerDetalles extends Component {
    ...
    public function ver($id, $tipo){
        ...
        $this->editar = false;
        if($tipo == 1){
            $this->titulo = "Nuevo Catalogo de Editoriales";
        }elseif($tipo == 2){
            $this->titulo = "Visualizacion de Catalogo de Editoriales";
        }elseif($tipo == 3){
            $this->titulo = "Edición de Catalogo de Editoriales";
        }
        if($id){
            $this->catalogo = CatalogoEditorial::find($id);
    ...
    public function brCat(){
        $del1 = CatalogoEditorial::where('id', $this->idDel)->delete();
    ...
    public function guardar(){
        ...
        if($this->editar){
            ...
            $sav2 = CatalogoEditorial::create($this->state);
    ...
    public function render(){
        return view('livewire.biblioteca.configuracion.catalogo-editoriales.components.ver-detalles');
    }
}
