<?php
namespace App\Livewire\Biblioteca\Configuracion\CatalogoCategorias\Components;
...
class VerDetalles extends Component {
    ...
    public function ver($id, $tipo){
        ...
        $this->editar = false;
        if($tipo == 1){
            $this->titulo = "Nuevo Catalogo de Categorías";
        }elseif($tipo == 2){
            $this->titulo = "Visualizacion de Catalogo de Categorías";
        }elseif($tipo == 3){
            $this->titulo = "Edición de Catalogo de Categorías";
        }
        if($id){
            $this->catalogo = CatalogoCategoria::find($id);
    ...
    public function brCat(){
        $del1 = CatalogoCategoria::where('id', $this->idDel)->delete();
    ...
    public function guardar(){
        ...
        if($this->editar){
            ...
            $sav2 = CatalogoCategoria::create($this->state);
    ...
    public function render(){
        return view('livewire.biblioteca.configuracion.catalogo-categorias.components.ver-detalles');
    }
}
