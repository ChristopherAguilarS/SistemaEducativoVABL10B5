<?php
namespace App\Livewire\Biblioteca\Configuracion\CatalogoIdiomas\Components;
...
class VerDetalles extends Component {
    ...
    public function ver($id, $tipo){
        ...
        $this->editar = false;
        if($tipo == 1){
            $this->titulo = "Nuevo Catalogo de Idiomas";
        }elseif($tipo == 2){
            $this->titulo = "Visualizacion de Catalogo de Idiomas";
        }elseif($tipo == 3){
            $this->titulo = "Edición de Catalogo de Idiomas";
        }
        if($id){
            $this->catalogo = CatalogoIdioma::find($id);
    ...
    public function brCat(){
        $del1 = CatalogoIdioma::where('id', $this->idDel)->delete();
    ...
    public function guardar(){
        ...
        if($this->editar){
            ...
            $sav2 = CatalogoIdioma::create($this->state);
    ...
    public function render(){
        return view('livewire.biblioteca.configuracion.catalogo-idiomas.components.ver-detalles');
    }
}
