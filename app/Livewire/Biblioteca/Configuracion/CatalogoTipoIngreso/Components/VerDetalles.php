<?php
namespace App\Livewire\Biblioteca\Configuracion\CatalogoTipoIngreso\Components;
...
class VerDetalles extends Component {
    ...
    public function ver($id, $tipo){
        ...
        $this->editar = false;
        if($tipo == 1){
            $this->titulo = "Nuevo Catalogo de Tipo de Ingreso";
        }elseif($tipo == 2){
            $this->titulo = "Visualizacion de Catalogo de Tipo de Ingreso";
        }elseif($tipo == 3){
            $this->titulo = "Edición de Catalogo de Tipo de Ingreso";
        }
        if($id){
            $this->catalogo = CatalogoTipoIngreso::find($id);
    ...
    public function brCat(){
        $del1 = CatalogoTipoIngreso::where('id', $this->idDel)->delete();
    ...
    public function guardar(){
        ...
        if($this->editar){
            ...
            $sav2 = CatalogoTipoIngreso::create($this->state);
    ...
    public function render(){
        return view('livewire.biblioteca.configuracion.catalogo-tipo-ingreso.components.ver-detalles');
    }
}
