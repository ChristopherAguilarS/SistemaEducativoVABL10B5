<?php
namespace App\Livewire\Biblioteca\Configuracion\CatalogoMaterias\Components;
...
class VerDetalles extends Component {
    ...
    public function ver($id, $tipo){
        ...
        $this->editar = false;
        if($tipo == 1){
            $this->titulo = "Nuevo Catalogo de Materias";
        }elseif($tipo == 2){
            $this->titulo = "Visualizacion de Catalogo de Materias";
        }elseif($tipo == 3){
            $this->titulo = "Edición de Catalogo de Materias";
        }
        if($id){
            $this->catalogo = CatalogoMateria::find($id);
    ...
    public function brCat(){
        $del1 = CatalogoMateria::where('id', $this->idDel)->delete();
    ...
    public function guardar(){
        ...
        if($this->editar){
            ...
            $sav2 = CatalogoMateria::create($this->state);
    ...
    public function render(){
        return view('livewire.biblioteca.configuracion.catalogo-materias.components.ver-detalles');
    }
}
