<?php
namespace App\Livewire\Patrimonio\Configuracion\CatalogoTipoPiso\Components;
...
class VerDetalles extends Component {
    ...
    public function ver($id, $tipo){
        ...
        if($id){
            $this->catalogo = CatalogoTipoPiso::find($id);
    ...
    public function brCat(){
        $del1 = CatalogoTipoPiso::where('id', $this->idDel)->delete();
    ...
    public function guardar(){
        ...
        if($this->editar){
            ...
            $sav2 = CatalogoTipoPiso::create($this->state);
    ...
    public function render(){
        return view('livewire.patrimonio.configuracion.catalogo-tipo-piso.components.ver-detalles');
    }
}
