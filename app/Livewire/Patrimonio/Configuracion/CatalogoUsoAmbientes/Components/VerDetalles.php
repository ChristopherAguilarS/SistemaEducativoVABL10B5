<?php
namespace App\Livewire\Patrimonio\Configuracion\CatalogoUsoAmbientes\Components;
...
class VerDetalles extends Component {
    ...
    public function ver($id, $tipo){
        ...
        $this->editar = false;
        if($tipo == 1){
            $this->titulo = "Nuevo Catalogo de Uso de Ambientes";
        }elseif($tipo == 2){
            $this->titulo = "Visualizacion de Catalogo de Uso de Ambientes";
        }elseif($tipo == 3){
            $this->titulo = "Edición de Catalogo de Uso de Ambientes";
        }
        if($id){
            $this->catalogo = CatalogoUsoAmbiente::find($id);
    ...
    public function brCat(){
        $del1 = CatalogoUsoAmbiente::where('id', $this->idDel)->delete();
    ...
    public function guardar(){
        ...
        if($this->editar){
            ...
            $sav2 = CatalogoUsoAmbiente::create($this->state);
    ...
    public function render(){
        return view('livewire.patrimonio.configuracion.catalogo-uso-ambientes.components.ver-detalles');
    }
}
