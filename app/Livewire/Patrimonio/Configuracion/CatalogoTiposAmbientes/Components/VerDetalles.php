<?php
namespace App\Livewire\Patrimonio\Configuracion\CatalogoTiposAmbientes\Components;
...
class VerDetalles extends Component {
    ...
    public function ver($id, $tipo){
        ...
        $this->editar = false;
        if($tipo == 1){
            $this->titulo = "Nuevo Catalogo de Tipos de Ambientes";
        }elseif($tipo == 2){
            $this->titulo = "Visualizacion de Catalogo de Tipos de Ambientes";
        }elseif($tipo == 3){
            $this->titulo = "Edición de Catalogo de Tipos de Ambientes";
        }
        if($id){
            $this->catalogo = CatalogoTipoAmbiente::find($id);
    ...
    public function brCat(){
        $del1 = CatalogoTipoAmbiente::where('id', $this->idDel)->delete();
    ...
    public function guardar(){
        ...
        if($this->editar){
            ...
            $sav2 = CatalogoTipoAmbiente::create($this->state);
    ...
    public function render(){
        return view('livewire.patrimonio.configuracion.catalogo-tipos-ambientes.components.ver-detalles');
    }
}
