<?php
namespace App\Livewire\Patrimonio\Configuracion\CatalogoPisos\Components;
...
class VerDetalles extends Component {
    ...
    public function ver($id, $tipo){
        ...
        $this->editar = false;
        if($tipo == 1){
            $this->titulo = "Nuevo Catalogo de Pisos";
        }elseif($tipo == 2){
            $this->titulo = "Visualizacion de Catalogo de Pisos";
        }elseif($tipo == 3){
            $this->titulo = "Edición de Catalogo de Pisos";
        }
        if($id){
            $this->catalogo = CatalogoPiso::find($id);
    ...
    public function brCat(){
        $del1 = CatalogoPiso::where('id', $this->idDel)->delete();
    ...
    public function guardar(){
        ...
        if($this->editar){
            ...
            $sav2 = CatalogoPiso::create($this->state);
    ...
    public function render(){
        return view('livewire.patrimonio.configuracion.catalogo-pisos.components.ver-detalles');
    }
}
