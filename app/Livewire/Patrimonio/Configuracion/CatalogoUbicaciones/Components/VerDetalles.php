<?php
namespace App\Livewire\Patrimonio\Configuracion\CatalogoUbicaciones\Components;
...
class VerDetalles extends Component {
    ...
    public function ver($id, $tipo){
        ...
        $this->editar = false;
        if($tipo == 1){
            $this->titulo = "Nuevo Catalogo de Ubicaciones";
        }elseif($tipo == 2){
            $this->titulo = "Visualizacion de Catalogo de Ubicaciones";
        }elseif($tipo == 3){
            $this->titulo = "Edición de Catalogo de Ubicaciones";
        }
        if($id){
            $this->catalogo = CatalogoUbicacion::find($id);
    ...
    public function render(){
        return view('livewire.patrimonio.configuracion.catalogo-ubicaciones.components.ver-detalles');
    }
}
