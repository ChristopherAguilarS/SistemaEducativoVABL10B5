...
class Table extends Component
{
    ...
    public function mount(){
        ...
        $this->conceptos_ingresos = ConceptoIngreso::where('estado',1)->get();
        $this->estudiantes = Estudiante::where('estado',1)->get();
    }
    ...
    {
        $ingresos = Ingreso::where('estado',1)->paginate(10);
        return view('livewire.academico.ingreso.table',['ingresos'=>$ingresos]);
    }
}
