...
namespace App\Livewire\Academico\CursoCiclo;

use App\Livewire\Forms\CrearMacroProcesoForm;
use App\Models\Ciclo;
use App\Models\Curso;
use App\Models\CursoCicloAcademico;
...
class Table extends Component
{
    ...
    public $titulo = 'Crear Nuevo Curso para el ciclo';
    public $tituloRequisito = 'Agregar Curso';
    ...
    public function mount(){
        ...
        $this->ciclos = Ciclo::where('estado',1)->get();
    }
    ...
    public function agregar(){
        ...
        //$this->limpiarCampos();
        $this->titulo = 'Crear Nuevo Curso x Ciclo';
    }

    public function editar($id){
        $macroProceso = MacroProceso::find($id);
        $this->titulo = 'Editar Curso -'.optional($this->macroProcesoT)->descripcion;
    ...
    {
        $cursos = CursoCicloAcademico::where('estado',1)->paginate(10);
        return view('livewire.academico.curso-ciclo.table',['cursos'=>$cursos]);
    }
}
