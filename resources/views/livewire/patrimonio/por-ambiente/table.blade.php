                        ...
                        <table class="table table-nowrap table-striped-columns mb-4">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:5px" class="text-center" scope="col">Año</th>
                                    <th style="width:5px" class="text-center" scope="col">Inventariado</th>
                                            ...
                                            <td style="vertical-align:middle">
                                                <center>
                                                    @if($documento->inventariado)
                                                        <h4><span class="badge bg-success" style="color:white">SI</span></h4>
                                                    @else
                                                        <h4><span class="badge bg-warning">NO</span></h4>
                                                    @endif
                                                </center>
                                            </td>
                                            <td style="vertical-align:middle">
