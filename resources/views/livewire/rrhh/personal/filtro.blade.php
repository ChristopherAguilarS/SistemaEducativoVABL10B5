                        ...
                        <div class="col-xxl-6">
                            <div class="row g-2 text-center">
                                <div class="col-lg-12 text-center">
                                    <button title="Agregar Persona" @click="$dispatch('nuevo', [{{$selTab}}])" type="button" class="btn btn-outline-primary waves-effect waves-light material-shadow-none">
                                        <i class="bx bx-user-plus" style="font-size:30px"></i>
                                    </button>
                                    <button title="Estudios de Pre Grado" @click="$dispatch('preGrado', [{{$selTab}}])" type="button" class="btn btn-outline-primary waves-effect waves-light material-shadow-none">
                                        <i class="bx bxs-graduation" style="font-size:30px"></i>
                                    </button>
                                    <button title="Estudios de Post Grado" @click="$dispatch('postGrado', [{{$selTab}}])" type="button" class="btn btn-outline-primary waves-effect waves-light material-shadow-none">
                                        <i class="bx bx-book" style="font-size:30px"></i>
                                    </button>
                                    <button title="Colegiaturas" @click="$dispatch('colegiatura', [{{$selTab}}])" type="button" class="btn btn-outline-primary waves-effect waves-light material-shadow-none">
                                        <i class="bx bx-book-bookmark" style="font-size:30px"></i>
                                    </button>
                                    <button title="Experiencia Laboral" @click="$dispatch('experienciaLaboral', [{{$selTab}}])" type="button" class="btn btn-outline-primary waves-effect waves-light material-shadow-none">
                                        <i class="bx bx-briefcase" style="font-size:30px"></i>
                                    </button>
                                    <button title="Otros Estudios" @click="$dispatch('otrosEstudios', [{{$selTab}}])" type="button" class="btn btn-outline-primary waves-effect waves-light material-shadow-none">
