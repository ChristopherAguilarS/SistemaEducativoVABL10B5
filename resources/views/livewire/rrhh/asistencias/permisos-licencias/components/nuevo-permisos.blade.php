                                ...
                                <div class="card-header bg-light" style="    margin-left: 10px;">
                                    <div class="row" style="padding: 10px 25px;">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <span>Fecha:</span>
                                                <input wire:model="fecha" onchange="calcDias()" class="form-control" type="date">
                                                @error('fecha')
                                                    <span class="block text-left text-tiny sm:col-span-12 text-error">* Campo Obligatorio</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="mb-3">
                                                ...
                                                <input wire:model="inicio" onchange="calcDias()" class="form-control" type="time">
                                                @error('inicio')
                                                    <span class="block text-left text-tiny sm:col-span-12 text-error">* Campo Obligatorio</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="mb-3">
                                                <span>Hora Fin:</span>
                                                <input wire:model="fin" onchange="calcDias()" class="form-control" type="time">
                                                @error('fin')
                                                    <span class="block text-left text-tiny sm:col-span-12 text-error">* Campo Obligatorio</span>
                                                @enderror
                                            </div>
