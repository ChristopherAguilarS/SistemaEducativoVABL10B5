                                ...
                                <div class="card-header bg-light" style="    margin-left: 10px;">
                                    <div class="row" style="padding: 10px 25px;">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <span>Lugar:</span>
                                                <textarea wire:model="lugar" class="form-control" cols="30" rows="2"></textarea>
                                                @error('lugar')
                                                    <span class="block text-left text-tiny sm:col-span-12 text-error">* Campo Obligatorio</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-2">
                                                <span>Motivo de Comision:</span>
                                                <textarea wire:model="motivo" class="form-control" cols="30" rows="2"></textarea>
                                                @error('motivo')
                                                    <span class="block text-left text-tiny sm:col-span-12 text-error">* Campo Obligatorio</span>
                                                @enderror
                                            </div>
