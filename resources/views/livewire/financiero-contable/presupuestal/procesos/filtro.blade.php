<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="row">
                <div class="col-lg-3">                      
                    <select class="form-select m-3" aria-label="Macro Proceso" wire:model.live="macro_proceso_id">
                        <option value="">Seleccione MacroProceso </option>
                        @foreach ($macro_procesos as $macro)
                            <option value="{{ $macro->id }}">{{ $macro->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-lg-7">
