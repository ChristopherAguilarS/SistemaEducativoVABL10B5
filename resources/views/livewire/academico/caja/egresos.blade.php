        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Egresos</h4>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($especificas as $especifica)
                                    <tr>                
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-info btn-sm"  @click="$dispatch('nuevo', [{{ $especifica->id }}])"><i class="ri-edit-2-line"></i> Ver</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
