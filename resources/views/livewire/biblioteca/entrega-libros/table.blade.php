                                            ...
                                            <td>
                                                <div class="btn-group material-shadow">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item cursor-pointer"  wire:click="$dispatch('nuevo', [{{$data->id}}, 3])"><i class="mdi mdi-file-upload-outline" style="font-size:20px"></i> <b>ENTREGA</b></a>
                                                        <a class="dropdown-item cursor-pointer"  wire:click="$dispatch('nuevo', [{{$data->id}}, 3])"><i class="mdi mdi-file-download-outline" style="font-size:20px"></i> <b>RECEPCION</b></a>
