            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="contable">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('cuentas')}}" class="nav-link">Cuentas
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="financiero">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('tipo-transaccion')}}" class="nav-link">Tipo de Transacciones
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('generica')}}" class="nav-link">Genericas
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('sub-generica-nivel-1')}}" class="nav-link">Sub Genericas 1
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('sub-generica-nivel-2')}}" class="nav-link">Sub Genericas 2
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('especifica-nivel-1')}}" class="nav-link">Especificas 1
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('especifica-nivel-2')}}" class="nav-link">Especificas 2
                                </a>
                            </li>
                        </ul>
                    </div>
