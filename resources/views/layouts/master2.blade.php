                        ...
                        <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                            ...
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-xl-2">
                                    ...
                                    <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{optional(Auth::user()->area)->descripcion}}</span>
                                </span>
                            </span>
                        </button>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <a href="{{ route($prin->vista.'/index') }}" class="card card-animate" style="background-color:{{$prin->color}}">
                                        <div class="card-body text-center">
                                            ...
                                            <br>
                                            <b style="font-size:20px; color:white" class="top:4px">{{$prin->nombre}}</b>
                                        </div><!-- end card body -->
                                    </a><!-- end card -->
                                </div><!-- end col -->
                            @endforeach
