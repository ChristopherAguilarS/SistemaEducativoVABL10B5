...
[$__name, $__params] = $__split('financiero-contable.contabilidad.caja-chica.cards');

$__html = app('livewire')->mount($__name, $__params, 'lw-422142585-0', $__slots ?? [], get_defined_vars());
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $movimientos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movimiento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>                
                                        ...
                                        <td>
                                            <?php echo e(optional(optional($movimiento)->cuenta)->descripcion); ?>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="mb-3 col-3">
                                ...
                                <select <?php echo e($deshabilitar); ?> class="form-control" id="tipo" name="state" wire:model.live='form.tipo'>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="mb-3 col-3">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($apertura == false && $cierre == false): ?>
                                ...
                                <?php elseif($apertura == true): ?>
                                    <select <?php echo e($deshabilitar); ?> class="form-control" id="categoria_id" name="categoria_id" wire:model='form.categoria_id'>
                                        <option value="1">Aperturar Caja Chica</option>
                                    </select>
                                <?php elseif($cierre == true): ?>
                                    <select <?php echo e($deshabilitar); ?> class="form-control" id="categoria_id" name="categoria_id" wire:model='form.categoria_id'>
                                        <option value="8">Cerrar Caja Chica</option>
                                    </select>
                                <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->
                                <div>
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['form.categoria_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="error"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="mb-3 col-6"> 
                                ...
                                <div>
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['form.descripcion_categoria'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="error"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($form->tipo == 2): ?>
                            <div class="mb-3 col-3">
                                <label for="comprobante" class="form-label">Comprobante:</label>
                                <input <?php echo e($deshabilitar); ?> type="text" class="form-control" placeholder="Comprobante" id="comprobante" wire:model='form.comprobante'>
                                <div>
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['form.comprobante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="error"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="mb-3 col-6" wire:ignore>
                                ...
                                <select <?php echo e($deshabilitar); ?> class="js-example-basic-single" id="cuenta_id" name="state" wire:model='form.cuenta_id'>
                                    <option value="">Seleccionar Opcion</option>
...
<?php /**PATH D:\Sistema Educativo - B5\resources\views/livewire/financiero-contable/contabilidad/caja-chica/table.blade.php ENDPATH**/ ?>