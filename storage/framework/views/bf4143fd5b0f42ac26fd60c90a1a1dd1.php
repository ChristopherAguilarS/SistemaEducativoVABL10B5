        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Especificas 1</h4>
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $especificas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $especifica): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>                
                                        ...
                                        <td>
                                            <?php echo e(optional(optional($especifica)->subgenericanivel2)->descripcion); ?>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="mb-3" wire:ignore>
                            <label for="sub_generica_nivel_2_id" class="col-form-label">Sub Generica 2 Nivel:</label>
                            <select class="js-example-basic-single" id="sub_generica_nivel_2_id" name="state" wire:model='form.sub_generica_nivel_2_id'>
                        ...
                        <div>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['form.sub_generica_nivel_2_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="error"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
        ...
        <?php
        $__scriptKey = '307571871-0';
        ob_start();
    ?>
        <script>
            $('#sub_generica_nivel_2_id').select2({
                placeholder: 'Seleccione una opcion',
                dropdownParent: '#myModal'
            });
            $('#sub_generica_nivel_2_id').on('change',function(){
                let a = document.getElementById("sub_generica_nivel_2_id").value;
                $wire.set('form.sub_generica_nivel_2_id',a);
            })
            $wire.on('cambiarSeleccion', (event) => {
                $('#sub_generica_nivel_2_id').val(event.id);
                $('#sub_generica_nivel_2_id').trigger('change');
            });
            $wire.on('anularSeleccion', (event) => {
                $('#sub_generica_nivel_2_id').val(null).trigger('change');
            });
        </script>
        <?php
...
<?php /**PATH D:\Sistema Educativo - B5\resources\views/livewire/configuracion/financiero/especifica-nivel-1/table.blade.php ENDPATH**/ ?>