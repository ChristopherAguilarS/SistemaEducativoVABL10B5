                        ...
                        <table class="table table-nowrap table-striped-columns mb-4">
                            ...
                            <tr>                
                                ...
                                <td class="text-center">
                                    <!--[if BLOCK]><![endif]--><?php if($subgenerica->estado == 1): ?>
                                        <button type="button" class="btn btn-danger bg-gradient waves-effect waves-light" wire:click='cambiarEstado(<?php echo e($subgenerica->id); ?>)'>Dar de Baja <i class="ri-thumb-down-line align-bottom me-1"></i></button>
                                    
                                    <?php else: ?>
                                        <button type="button" class="btn btn-success bg-gradient waves-effect waves-light" wire:click='cambiarEstado(<?php echo e($subgenerica->id); ?>)'>Dar de Alta <i class="ri-thumb-up-line align-bottom me-1"></i></button>
                                    <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->
                                        <button type="button" class="btn btn-info bg-gradient waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal" wire:click='editar(<?php echo e($subgenerica->id); ?>)'>Editar <i class="las la-edit"></i></button>
                                </td>
                            </tr>
                        ...
                        <div class="mb-3" wire:ignore>
                            ...
                            <select class="js-example-basic-single" id="generica_id" name="state" wire:model='form.generica_id'>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $genericas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $generica): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($generica->id); ?>"><?php echo e($generica->id); ?> - <?php echo e($generica->descripcion); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <!--[if ENDBLOCK]><![endif]-->
                            </select>
                        </div>                        
                        <div>
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['form.generica_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="error"><?php echo e($message); ?></span> <?php unset($message);
